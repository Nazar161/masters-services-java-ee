                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="title" id="title" class="form-control" readonly
                                       value="${servicesDelete[0].getTitle()}"/>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="duration" class="col-sm-3 col-form-label">Продолжительность</label>
                            <div class="col-sm-7">
                                <input type="number" step="0.5" name="duration" id="duration" class="form-control" readonly
                                       value="${servicesDelete[0].getDuration()}"/>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="price" class="col-sm-3 col-form-label">Стоимость</label>
                            <div class="col-sm-7">
                                <input type="number" step="50" name="price" id="price" class="form-control" readonly
                                       value="${servicesDelete[0].getPrice()}"/>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-7" style="padding-right: 0">
                                <select class="form-control" name="master" id="master">
                                    ...
                                    <c:forEach var="master" items="${masters}">
                                        <option value="${master.getId()}" ${servicesDelete[0].getIdMaster() == master.getId() ? "selected" : null} disabled>
