                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="fullName" id="fullName" class="form-control" readonly
                                       value="${mastersDelete[0].getFullName()}"/>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="post" class="col-sm-3 col-form-label">Должность</label>
                            <div class="col-sm-8">
                                <input type="text" name="post" id="post" class="form-control" readonly
                                       value="${mastersDelete[0].getPost()}"/>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="phone" id="phone" class="form-control" readonly
                                       value="${mastersDelete[0].getPhone()}"/>
                            </div>
                        </div>
                        <p>
